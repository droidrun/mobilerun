...
# Create custom LLMs
llms = {
    "manager": load_llm("Anthropic", model="claude-sonnet-5"),
    "executor": load_llm("Anthropic", model="claude-sonnet-5"),
    "fast_agent": load_llm("OpenAIResponses", model="gpt-6-astra"),
    "app_opener": load_llm("OpenAIResponses", model="gpt-6-sol"),
    "structured_output": load_llm("OpenAIResponses", model="gpt-6-sol"),
}
...
llm = load_llm("OpenAIResponses", model="gpt-6-astra")
