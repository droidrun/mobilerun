...
<Note>
Most LLM providers (Google Gemini, OpenAI, DeepSeek, Ollama, OpenRouter, OrcaRouter) are included by default. For additional providers, install extras: `uv tool install 'mobilerun[anthropic]'`.
</Note>
